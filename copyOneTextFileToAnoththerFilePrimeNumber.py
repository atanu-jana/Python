...
file1 = filetolistofints('/media/atanu/MyFile1/Zip/Python Zip/Python-Programming-Practice-master/Day12/one.txt')
file2 = filetolistofints('/media/atanu/MyFile1/Zip/Python Zip/Python-Programming-Practice-master/Day12/two.txt')
